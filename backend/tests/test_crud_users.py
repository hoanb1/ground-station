...
class TestUsersCRUD:
    ...
    async def test_add_user_success(self, db_session):
        ...
        assert bcrypt.checkpw(
            "securepassword123".encode("utf-8"), result["data"]["password"].encode("utf-8")
        )

    async def test_add_user_missing_email(self, db_session):
        """Test user creation fails without email."""
        user_data = {"password": "securepassword123", "fullname": "Test User", "status": "active"}
    ...
    async def test_add_user_missing_password(self, db_session):
        ...
        user_data = {"email": "test@example.com", "fullname": "Test User", "status": "active"}
    ...
    async def test_edit_user_success(self, db_session):
        ...
        # Edit the user
        edit_data = {"id": user_id, "fullname": "New Name", "status": "inactive"}
    ...
    async def test_edit_user_password(self, db_session):
        ...
        # Change password
        edit_data = {"id": user_id, "password": "newpass123"}
    ...
    async def test_edit_user_not_found(self, db_session):
        ...
        fake_id = uuid.uuid4()
        edit_data = {"id": fake_id, "fullname": "New Name"}
