...
const initialState = {
    ...
    bookmarks: [],
    vfoMarkers: {
        1: {active: false, name: "VFO1", bandwidth: 4300, frequency: null, color: null, mode: 'usb', 'selected': false,},
        2: {active: false, name: "VFO2", bandwidth: 100000, frequency: null, color: null, mode: 'fm', 'selected': false,},
        3: {active: false, name: "VFO3", bandwidth: 5000, frequency: null, color: null, mode: 'lsb', 'selected': false,},
