...
let TLEs = {
    ...
    28654: {
        noradid: 28654,
        name: "NOAA 18",
        tleLine1: '1 28654U 05018A   25063.43842834  .00000384  00000+0  22718-3 0  9998',
        tleLine2: '2 28654  98.8482 143.9938 0014757  48.9110 311.3335 14.13532384 20027',
        currentLonLat: [0, 0],
        currentAlt: 0,
        currentVel: [0, 0, 0]
    },
    ...
    27509: {
        noradid: 27509,
        name: "METEOSAT 8",
        tleLine1: '1 27509U 02040B   25063.40522891 -.00000119  00000-0  00000-0 0  9998',
        tleLine2: '2 27509  10.3278  44.8214 0013803  62.4171 318.7461  0.97903186 82345',
        currentLonLat: [0, 0],
        currentAlt: 0,
        currentVel: [0, 0, 0]
    },
    40732: {
        noradid: 40732,
        name: "MSG 4",
        tleLine1: '1 40732U 15034A   25062.83020355  .00000058  00000-0  00000-0 0  9993',
        tleLine2: '2 40732   2.0245  72.1551 0000800 290.8065 107.1734  1.00264908  2500',
        currentLonLat: [0, 0],
        currentAlt: 0,
        currentVel: [0, 0, 0]
    },
