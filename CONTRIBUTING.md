...
*   **Python:** We use the [PEP 8](https://www.python.org/dev/peps/pep-0008/) coding style for Python code.
*   **JavaScript:** We use the [Prettier](https://prettier.io/) code formatter for JavaScript code.